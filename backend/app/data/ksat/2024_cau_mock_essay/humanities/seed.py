"""Seed entry for 2024 CAU humanities mock essay.

Registered by app/data/ksat/seed_ksat_data.py. Like the 2025 CAU exam,
all three questions share the same passage set ((가)~(차)); the per-question
passages/q_*.md files therefore hold identical content. The passage_refs
field records which sub-passages each question actually relies on.
"""
...
QUESTIONS = [
    ...
    },
    {
        ...
        "rubric_name": "KSAT 2024 CAU Humanities Q2",
    },
    {
        "question_number": 3,
        ...
        "char_max": 350,
        "passage_refs": ["아", "자", "차"],
        "rubric_name": "KSAT 2024 CAU Humanities Q3",
    },
]
