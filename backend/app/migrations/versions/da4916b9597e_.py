...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name=op.f('fk_social_account_user_id_user')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_social_account')),
    sa.UniqueConstraint('provider_user_id', name=op.f('uq_social_account_provider_user_id'))
    )
    ...
    sa.Column('sender', sa.Enum('user', 'bot', name='conversationsendertype'), nullable=False),
    sa.Column('sender_id', sa.Integer(), nullable=False),
    sa.Column('message', sa.String(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['chat_session_id'], ['chat_session.id'], name=op.f('fk_conversation_chat_session_id_chat_session')),
